...
class Constants:
    ...
    ema_alpha_throttle: float = 0.3        # Throttle smoothing factor. Lower numbers are smoother, higher numbers are more responsive
    ema_alpha_steering: float = 0.3        # Steering smoothing factor. Lower numbers are smoother, higher numbers are more resposnive
